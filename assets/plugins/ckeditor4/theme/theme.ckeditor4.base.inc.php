...
$this->set('skin',                  $this->modxParams['skin'] );                  // Overwrite with Modx-setting
$this->set('enterMode',             'p',                            'constant' ); // Translated via bridge.ckeditor4.inc.php
$this->set('width',                 $this->pluginParams['width'],   'string' );   // Set width as per plug-configuration
$this->set('height',                $this->pluginParams['height'],  'string' );   // Set width as per plug-configuration
...
// Required for plugin embed since v4.7
$this->set('embed_provider',        'ckeditor.iframe.ly/api/oembed?url={url}&callback={callback}', 'string' );

// Filebrowser config
$this->set('filebrowserBrowseUrl', '[+site_manager_url+]media/browser/[+which_browser+]/browse.php?opener=ckeditor4&type=files', 'string');
$this->set('filebrowserImageBrowseUrl', '[+site_manager_url+]media/browser/[+which_browser+]/browse.php?opener=ckeditor4&type=images', 'string');
$this->set('filebrowserFlashBrowseUrl', '[+site_manager_url+]media/browser/[+which_browser+]/browse.php?opener=ckeditor4&type=flash', 'string');
